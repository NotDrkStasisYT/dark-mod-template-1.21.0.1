...
public class TavernKegStationBlockEntityRenderer implements BlockEntityRenderer<TavernKegStationBlockEntity> {

    public TavernKegStationBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(TavernKegStationBlockEntity entity, float tickDelta, MatrixStack matrices,
    ...
    @Override
    public boolean rendersOutsideBoundingBox(TavernKegStationBlockEntity blockEntity) {
