...
public class TavernKegBlockEntity extends BlockEntity {
    ...
    public TavernKegBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.TAVERN_KEG, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, TavernKegBlockEntity keg) {
        if (keg.hasItem()) {
