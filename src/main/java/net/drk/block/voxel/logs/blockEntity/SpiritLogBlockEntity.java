...
import net.drk.block.voxel.logs.block.SpiritLog;
...
public class SpiritLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = SpiritLog.ROTATION;


    public SpiritLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SPIRIT_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, SpiritLogBlockEntity entity) {
