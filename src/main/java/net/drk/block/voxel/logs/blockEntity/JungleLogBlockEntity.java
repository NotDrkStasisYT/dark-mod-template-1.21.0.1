...
import net.drk.block.voxel.logs.block.JungleLog;
...
public class JungleLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = JungleLog.ROTATION;


    public JungleLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.JUNGLE_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, JungleLogBlockEntity entity) {
