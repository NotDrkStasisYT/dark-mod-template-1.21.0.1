...
import net.drk.block.voxel.logs.block.BirchLog;
...
public class BirchLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = BirchLog.ROTATION;


    public BirchLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.BIRCH_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, BirchLogBlockEntity entity) {
