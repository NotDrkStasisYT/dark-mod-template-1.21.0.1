...
public class BirchLogBlockEntityRenderer implements BlockEntityRenderer<BirchLogBlockEntity> {

    public BirchLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(BirchLogBlockEntity entity, float tickDelta, MatrixStack matrices,
