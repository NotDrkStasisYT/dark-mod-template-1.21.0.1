...
import net.drk.block.voxel.logs.block.AutumnLog;
...
public class AutumnLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = AutumnLog.ROTATION;


    public AutumnLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.AUTUMN_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, AutumnLogBlockEntity entity) {
