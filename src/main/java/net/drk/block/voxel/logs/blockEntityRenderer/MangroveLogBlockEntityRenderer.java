...
public class MangroveLogBlockEntityRenderer implements BlockEntityRenderer<MangroveLogBlockEntity> {

    public MangroveLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(MangroveLogBlockEntity entity, float tickDelta, MatrixStack matrices,
