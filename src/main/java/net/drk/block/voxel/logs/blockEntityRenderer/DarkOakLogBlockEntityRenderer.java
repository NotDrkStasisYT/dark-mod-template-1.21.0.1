...
public class DarkOakLogBlockEntityRenderer implements BlockEntityRenderer<DarkOakLogBlockEntity> {

    public DarkOakLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(DarkOakLogBlockEntity entity, float tickDelta, MatrixStack matrices,
