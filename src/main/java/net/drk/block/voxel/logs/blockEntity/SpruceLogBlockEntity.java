...
import net.drk.block.voxel.logs.block.SpruceLog;
...
public class SpruceLogBlockEntity extends BlockEntity {
    private int maxHealth = 20; // Example starting health
    private int health = 20; // Example starting health
    ...
    public static final IntProperty ROTATION = SpruceLog.ROTATION;


    public SpruceLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SPRUCE_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, SpruceLogBlockEntity entity) {
