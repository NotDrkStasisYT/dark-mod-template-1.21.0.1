...
import net.drk.block.voxel.logs.block.MangroveLog;
...
public class MangroveLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = MangroveLog.ROTATION;


    public MangroveLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.MANGROVE_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, MangroveLogBlockEntity entity) {
