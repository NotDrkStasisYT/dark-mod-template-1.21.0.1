...
public class AutumnLogBlockEntityRenderer implements BlockEntityRenderer<AutumnLogBlockEntity> {

    public AutumnLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(AutumnLogBlockEntity entity, float tickDelta, MatrixStack matrices,
