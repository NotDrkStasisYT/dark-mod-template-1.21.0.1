...
public class JungleLogBlockEntityRenderer implements BlockEntityRenderer<JungleLogBlockEntity> {

    public JungleLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(JungleLogBlockEntity entity, float tickDelta, MatrixStack matrices,
