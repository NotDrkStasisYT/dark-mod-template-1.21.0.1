...
public class AcaciaLogBlockEntityRenderer implements BlockEntityRenderer<AcaciaLogBlockEntity> {

    public AcaciaLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(AcaciaLogBlockEntity entity, float tickDelta, MatrixStack matrices,
