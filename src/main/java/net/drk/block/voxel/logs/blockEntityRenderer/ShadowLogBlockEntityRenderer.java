...
public class ShadowLogBlockEntityRenderer implements BlockEntityRenderer<ShadowLogBlockEntity> {

    public ShadowLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(ShadowLogBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        for (int i = 0; i < filledSegments; i++) {
            coloredHealthBar.append("§0■"); // '§6' is the color code for orange
        }
