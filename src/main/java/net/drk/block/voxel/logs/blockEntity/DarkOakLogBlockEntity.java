...
import net.drk.block.voxel.logs.block.DarkOakLog;
...
public class DarkOakLogBlockEntity extends BlockEntity {
    private int maxHealth = 1000; // Example starting health
    private int health = 1000; // Example starting health
    ...
    public static final IntProperty ROTATION = DarkOakLog.ROTATION;


    public DarkOakLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.DARK_OAK_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, DarkOakLogBlockEntity entity) {
