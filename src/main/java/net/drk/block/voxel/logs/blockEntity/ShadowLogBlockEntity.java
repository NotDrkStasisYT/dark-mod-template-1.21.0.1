...
import net.drk.block.voxel.logs.block.ShadowLog;
...
public class ShadowLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = ShadowLog.ROTATION;


    public ShadowLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SHADOW_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, ShadowLogBlockEntity entity) {
