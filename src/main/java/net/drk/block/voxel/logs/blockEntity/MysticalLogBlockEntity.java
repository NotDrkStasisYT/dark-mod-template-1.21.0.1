...
import net.drk.block.voxel.logs.block.MysticalLog;
...
public class MysticalLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = MysticalLog.ROTATION;


    public MysticalLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.MYSTICAL_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, MysticalLogBlockEntity entity) {
