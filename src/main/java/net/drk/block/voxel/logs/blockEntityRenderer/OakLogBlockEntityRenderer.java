...
public class OakLogBlockEntityRenderer implements BlockEntityRenderer<OakLogBlockEntity> {

    public OakLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(OakLogBlockEntity entity, float tickDelta, MatrixStack matrices,
