...
public class SpiritLogBlockEntityRenderer implements BlockEntityRenderer<SpiritLogBlockEntity> {

    public SpiritLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(SpiritLogBlockEntity entity, float tickDelta, MatrixStack matrices,
