...
import net.drk.block.voxel.logs.block.CherryLog;
...
public class CherryLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = CherryLog.ROTATION;


    public CherryLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CHERRY_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, CherryLogBlockEntity entity) {
