...
public class MysticalLogBlockEntityRenderer implements BlockEntityRenderer<MysticalLogBlockEntity> {

    public MysticalLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(MysticalLogBlockEntity entity, float tickDelta, MatrixStack matrices,
