...
import net.drk.block.voxel.logs.block.OakLog;
...
public class OakLogBlockEntity extends BlockEntity {
    ...
    public static final IntProperty ROTATION = OakLog.ROTATION;


    public OakLogBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.OAK_LOG, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, OakLogBlockEntity entity) {
