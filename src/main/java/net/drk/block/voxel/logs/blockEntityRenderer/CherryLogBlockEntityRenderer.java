...
public class CherryLogBlockEntityRenderer implements BlockEntityRenderer<CherryLogBlockEntity> {

    public CherryLogBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(CherryLogBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        for (int i = 0; i < filledSegments; i++) {
            coloredHealthBar.append("§c■"); // '§6' is the color code for orange
        }
