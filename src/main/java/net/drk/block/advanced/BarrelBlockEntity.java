...
public class BarrelBlockEntity extends BlockEntity {
    ...
    public BarrelBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.BARREL, pos, state);  // You will need to register the entity type elsewhere
    ...
    public static void tick(World world, BlockPos pos, BlockState state, BarrelBlockEntity entity) {
